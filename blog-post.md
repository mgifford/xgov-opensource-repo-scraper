...
- [sbom.json.gz](https://uk-x-gov-software-community.github.io/xgov-opensource-repo-scraper/sbom.json.gz) — consolidated CycloneDX SBOM for all catalogued repositories (gzipped; a [runtime-only](https://uk-x-gov-software-community.github.io/xgov-opensource-repo-scraper/sbom-runtime.json.gz) variant for CVE scanning is also published)
